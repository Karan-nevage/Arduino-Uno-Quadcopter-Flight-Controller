...
void loop(){
  ...
  delay(1000);
  TWBR = 12;                      //Set the I2C clock speed to 400kHz(more inf check wire.h libray documentation).
  ...
  if(error == 0){
    ...
    Serial.println(F(""));
    Serial.println(F("==================================================="));
    Serial.println(F("Search Gyro Sensor"));
    Serial.println(F("==================================================="));
    delay(2000);
    ...
    if(type == 0){
      Serial.println(F("Unable to find gyro!!! (ERROR 3)"));
      error = 1;
    }
  ...
  if(error == 0){
    ...
    Serial.println(F("==================================================="));
    Serial.println(F("Don't move the quadcopter!! Calibration starts in 5 seconds"));
    delay(5000);
...
void intro(){
  ...
  delay(1000);
  Serial.println(F(""));
  Serial.println(F("Setup Program Starting"));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  delay(1500);
}
